 ...
 */
public class MessageServerListenerQueue {

    private static MessageServerListenerQueue listenerQueue = new MessageServerListenerQueue();
    private Logger logger = Logger.getLogger(MessageServerListenerQueue.class);
    public static MessageServerListenerQueue instance(){
    ...
    public Packetlistener pop(int seqNo){
        synchronized (MessageServerListenerQueue.this) {
