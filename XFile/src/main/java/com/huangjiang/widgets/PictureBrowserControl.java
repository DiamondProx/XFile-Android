...
import com.huangjiang.model.PictureVO;
import com.huangjiang.picture.ImageScanner;
import com.huangjiang.picture.ImageScanner.ScanCompleteCallBack;
import com.huangjiang.picture.LocalImageView;
import com.huangjiang.picture.LocalImageView.OnMeasureListener;
import com.huangjiang.picture.NativeImageLoader;
import com.huangjiang.picture.NativeImageLoader.NativeImageCallBack;
...
public class PictureBrowserControl extends StickyGridHeadersGridView {
	...
	List<PictureVO> mList = new ArrayList<PictureVO>();
		...
		mScanner.scanImages(new ScanCompleteCallBack() {
			...
			public void scanComplete(Cursor cursor) {
				...
				while (cursor.moveToNext()) {
					...
					PictureVO pictureVO = new PictureVO(path, Utils.paserTimeToYMD(times));
					mList.add(pictureVO);
				...
				for (ListIterator<PictureVO> it = mList.listIterator(); it.hasNext();) {
					PictureVO mGridItem = it.next();
	...
	class PictureAdapter extends BaseAdapter implements StickyGridHeadersSimpleAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			PictureVO vo = mList.get(position);
			if (vo != null) {
