...
import com.huangjiang.apkinfo.AppScanner;
import com.huangjiang.apkinfo.AppScanner.ScanAppsCompleteCallBack;
...
public class AppBrowserControl extends StickyGridHeadersGridView{
	...
	List<AppVO> mList = new ArrayList<AppVO>();
